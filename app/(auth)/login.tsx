...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    ...
    // RouteGuard in _layout.tsx handles navigation on session change
  }
      ...
      >
        ...
        >
          ...
          <View style={styles.logoWrap}>
            ...
            <Text style={styles.tagline}>Your AI language coach</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  kav: { flex: 1 },
  content: { flexGrow: 1, paddingHorizontal: 28, paddingVertical: 20, gap: 32 },
