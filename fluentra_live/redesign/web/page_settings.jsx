        ...
        <div style={{ maxWidth:980, margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'220px 1fr', gap:32 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:2, position:'sticky', top:0, alignSelf:'flex-start' }}>
              ...
              <button onClick={async () => { if (window.__signOut) await window.__signOut(); else window.__nav && window.__nav('auth_login'); }} style={{ display:'flex', alignItems:'center', gap:10, padding:'10px 12px', borderRadius:9, fontSize:13, fontWeight:500, color:T.brand, textAlign:'left', cursor:'pointer' }}>
    ...
    <MobileFrame>
      <MobileBody>
        ...
        <div style={{ margin:'18px 16px 32px' }}>
          <Btn onClick={async () => { if (window.__signOut) await window.__signOut(); else window.__nav && window.__nav('auth_login'); }} label="Sign out" variant="outline" accent={T.brand} fullWidth icon={Icon.x({ width:13, height:13 })}/>
