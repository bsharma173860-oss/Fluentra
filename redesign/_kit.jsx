...
const EXAMS = {
  ...
  ja: {
    ...
    cost: '$5',
    modules: [
      { ic:'pen',  label:'文字・語彙 (Vocab/Kanji)',   time:'25 min', q:30, color:'writing', kind:'reading' },
  ...
  ko: {
    name: 'TOPIK II',
    short: 'TOPIK',
    body: 'NIIED · Korea Institute for Curriculum and Evaluation',
    scoreLabel: 'Level',
    scoreUnit: '/300',
    bestScore: 'Level 4',
    nextLevel: 'Level 5',
    ...
    cost: '$5',
    modules: [
      { ic:'head', label:'듣기 (Listening)', time:'60 min', q:50, color:'listening', kind:'listening' },
      { ic:'pen',  label:'쓰기 (Writing)',    time:'50 min', q:4,  color:'writing',   kind:'writing' },
      { ic:'book', label:'읽기 (Reading)',    time:'70 min', q:50, color:'reading',   kind:'reading' },
    ],
    blurb: 'TOPIK II — listening, writing and reading. The standard TOPIK has no speaking module.',
  },
  zh: {
    name: 'HSK 4',
    short: 'HSK',
    body: 'Hanban · Chinese Testing International (CTI)',
    scoreLabel: 'Score',
    scoreUnit: '/300',
    bestScore: 240,
    nextLevel: 'HSK 5',
    ...
    cost: '$5',
    modules: [
      { ic:'head', label:'听力 (Listening)', time:'30 min', q:45, color:'listening', kind:'listening' },
      { ic:'book', label:'阅读 (Reading)',   time:'40 min', q:40, color:'reading',   kind:'reading' },
      { ic:'pen',  label:'书写 (Writing)',    time:'25 min', q:15, color:'writing',   kind:'writing' },
    ],
    blurb: 'HSK 4 — listening, reading and writing. Spoken Chinese is tested separately as HSKK.',
  },
  de: {
    name: 'Goethe-Zertifikat B1',
    short: 'Goethe',
    body: 'Goethe-Institut · official German certification',
    scoreLabel: 'Punkte',
    scoreUnit: '/100',
    bestScore: 72,
    nextLevel: 'B2',
    ...
    cost: '$5',
    modules: [
      { ic:'book', label:'Lesen (Reading)',      time:'65 min', q:30, color:'reading' },
      { ic:'head', label:'Hören (Listening)',    time:'40 min', q:30, color:'listening' },
      { ic:'pen',  label:'Schreiben (Writing)',  time:'60 min', q:3,  color:'writing' },
      { ic:'mic',  label:'Sprechen (Speaking)',  time:'15 min', q:3,  color:'speaking' },
    ],
    blurb: 'Goethe-Zertifikat B1 — vier Module (Lesen, Hören, Schreiben, Sprechen). Jedes Modul wird einzeln mit bis zu 100 Punkten bewertet.',
  },
  it: {
    name: 'CILS B1',
    short: 'CILS',
    body: 'Università per Stranieri di Siena',
    scoreLabel: 'Punti',
    scoreUnit: '/100',
    bestScore: 66,
    nextLevel: 'B2',
    ...
    cost: '$5',
    modules: [
      { ic:'head', label:'Ascolto (Listening)',          time:'30 min', q:30, color:'listening' },
      { ic:'book', label:'Comprensione lettura (Reading)', time:'50 min', q:30, color:'reading' },
      { ic:'pen',  label:'Produzione scritta (Writing)',  time:'70 min', q:2,  color:'writing' },
      { ic:'mic',  label:'Produzione orale (Speaking)',   time:'10 min', q:2,  color:'speaking' },
    ],
    blurb: 'CILS B1 — Università per Stranieri di Siena. Quattro abilità: ascolto, comprensione della lettura, produzione scritta e produzione orale.',
  },
  pt: {
    name: 'CELPE-Bras Intermediário',
    short: 'CELPE',
    body: 'Inep · Ministério da Educação do Brasil',
    scoreLabel: 'Nível',
    scoreUnit: '',
    bestScore: 'Intermediário',
    nextLevel: 'Intermediário Superior',
    levels: ['Intermediário','Intermediário Superior','Avançado','Avançado Superior'],
    duration: '2h 40min',
    cost: '$5',
    modules: [
      { ic:'head', label:'Compreensão oral (Listening)',  time:'30 min', q:20, color:'listening' },
      { ic:'book', label:'Compreensão de leitura (Reading)', time:'40 min', q:20, color:'reading' },
      { ic:'pen',  label:'Produção escrita (Writing)',    time:'60 min', q:2,  color:'writing' },
      { ic:'mic',  label:'Interação oral (Speaking)',     time:'20 min', q:3,  color:'speaking' },
    ],
    blurb: 'CELPE-Bras — exame oficial brasileiro de proficiência. Avalia compreensão e produção em situações reais de uso da língua.',
  },
  ru: {
    name: 'TORFL B1',
    short: 'TORFL',
    body: 'Pushkin State Russian Language Institute',
    scoreLabel: 'Балл',
    scoreUnit: '/100',
    bestScore: 66,
    nextLevel: 'B2',
    ...
    cost: '$5',
    modules: [
      { ic:'book', label:'Чтение (Reading)',     time:'50 min', q:25, color:'reading' },
      { ic:'head', label:'Аудирование (Listening)', time:'35 min', q:30, color:'listening' },
      { ic:'pen',  label:'Письмо (Writing)',     time:'60 min', q:2,  color:'writing' },
      { ic:'mic',  label:'Говорение (Speaking)', time:'15 min', q:3,  color:'speaking' },
    ],
    blurb: 'ТРКИ-1 (TORFL B1) — Pushkin Institute. Чтение, аудирование, письмо и говорение; каждый субтест оценивается отдельно.',
  },
};
