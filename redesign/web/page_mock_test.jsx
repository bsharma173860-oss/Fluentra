        ...
        <div style={{ maxWidth:920, margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1.4fr 1fr', gap:14, marginBottom:32 }}>
            <Card padding={0} style={{ overflow:'hidden', position:'relative' }}>
              <div style={{ background:T.ink, color:'#fff', padding:'22px 24px' }}>
                ...
                <div style={{ display:'flex', gap:10, marginTop:16 }}>
                  <Btn label="Start full mock" onClick={() => { if (window.__can && !window.__can('mockTests')) { window.__upgrade && window.__upgrade('mock'); } else { window.__examMode='mock'; window.__nav && window.__nav('mock_runner'); } }} accent={t.accent} size="md" iconRight={Icon.arrow({ width:12, height:12 })}/>
            ...
            <Card padding={22}>
              ...
              <Btn label="Start warm-up" onClick={() => { if (window.__can && !window.__can('mockTests')) { window.__upgrade && window.__upgrade('mock'); } else { window.__examMode='mock'; window.__nav && window.__nav('mock_runner'); } }} variant="outline" accent={t.accent} fullWidth iconRight={Icon.arrow({ width:11, height:11 })}/>
