...
function AddLanguagePage() {
  ...
  const fullCatalogue = [
    ...
    { code:'hi', native:'हिन्दी',          english:'Hindi',      speakers:'600M', exam:'CHD Praveen',               accent:'#C9501C', light:'#FBEDE2', tier:'full', region:'Asia' },
    ...
    { code:'vi', native:'Tiếng Việt',  english:'Vietnamese', speakers:'85M',  exam:'CEFR',              accent:'#DA251D', light:'#FBE5E7', tier:'cefr', region:'Asia' },
    { code:'id', native:'Indonesia',   english:'Indonesian', speakers:'199M', exam:'UKBI',              accent:'#CE1126', light:'#FBE5E8', tier:'cefr', region:'Asia' },
    { code:'uk', native:'Українська',  english:'Ukrainian',  speakers:'40M',  exam:'CEFR',               accent:'#005BBB', light:'#E5EFFB', tier:'cefr', region:'Europe' },
    { code:'ro', native:'Română',      english:'Romanian',   speakers:'24M',  exam:'CEFR',              accent:'#002B7F', light:'#E5E9F1', tier:'cefr', region:'Europe' },
    ...
    { code:'sw', native:'Kiswahili',   english:'Swahili',    speakers:'200M', exam:'CEFR',              accent:'#007A33', light:'#E5F2EC', tier:'soon', region:'Africa' },
    { code:'fa', native:'فارسی',        english:'Persian',    speakers:'110M', exam:'SAMFA',              accent:'#239F40', light:'#E5F2E9', tier:'soon', region:'Middle East' },
    { code:'ur', native:'اردو',         english:'Urdu',       speakers:'230M', exam:'CEFR',              accent:'#01411C', light:'#E5EEE6', tier:'soon', region:'Asia' },
    { code:'bn', native:'বাংলা',         english:'Bengali',    speakers:'265M', exam:'CEFR',               accent:'#006A4E', light:'#E5EFEB', tier:'soon', region:'Asia' },
    { code:'ta', native:'தமிழ்',          english:'Tamil',      speakers:'85M',  exam:'CEFR',              accent:'#C8102E', light:'#FBE5E9', tier:'soon', region:'Asia' },
    { code:'te', native:'తెలుగు',         english:'Telugu',     speakers:'95M',  exam:'CEFR',              accent:'#FF9933', light:'#FFEFD9', tier:'soon', region:'Asia' },
    { code:'mr', native:'मराठी',          english:'Marathi',    speakers:'95M',  exam:'CEFR',              accent:'#FF6B35', light:'#FBE5DA', tier:'soon', region:'Asia' },
    { code:'gu', native:'ગુજરાતી',         english:'Gujarati',   speakers:'56M',  exam:'CEFR',              accent:'#138808', light:'#E5F2E5', tier:'soon', region:'Asia' },
    { code:'ml', native:'മലയാളം',         english:'Malayalam',  speakers:'37M',  exam:'CEFR',              accent:'#1F8A6C', light:'#E5F1ED', tier:'soon', region:'Asia' },
    { code:'kn', native:'ಕನ್ನಡ',           english:'Kannada',    speakers:'45M',  exam:'CEFR',              accent:'#D62828', light:'#FBE5E5', tier:'soon', region:'Asia' },
    { code:'pa', native:'ਪੰਜਾਬੀ',           english:'Punjabi',    speakers:'125M', exam:'CEFR',              accent:'#FF6F00', light:'#FBEAD9', tier:'soon', region:'Asia' },
    { code:'tl', native:'Filipino',    english:'Filipino',   speakers:'45M',  exam:'CEFR',               accent:'#0038A8', light:'#E5EBF6', tier:'soon', region:'Asia' },
    { code:'ms', native:'Bahasa Melayu',english:'Malay',     speakers:'77M',  exam:'CEFR',              accent:'#CC0001', light:'#FBE5E5', tier:'soon', region:'Asia' },
    { code:'my', native:'မြန်မာ',          english:'Burmese',    speakers:'33M',  exam:'CEFR',              accent:'#FECB00', light:'#FFF8DA', tier:'soon', region:'Asia' },
    { code:'km', native:'ខ្មែរ',           english:'Khmer',      speakers:'17M',  exam:'CEFR',               accent:'#032EA1', light:'#E5E9F4', tier:'soon', region:'Asia' },
    { code:'mn', native:'Монгол',      english:'Mongolian',  speakers:'5M',   exam:'CEFR',             accent:'#C4272F', light:'#FBE6E8', tier:'soon', region:'Asia' },
    { code:'ne', native:'नेपाली',          english:'Nepali',     speakers:'32M',  exam:'CEFR',                accent:'#DC143C', light:'#FBE5E9', tier:'soon', region:'Asia' },
    { code:'si', native:'සිංහල',         english:'Sinhala',    speakers:'17M',  exam:'CEFR',               accent:'#FFB000', light:'#FFF4D9', tier:'soon', region:'Asia' },
    ...
    { code:'am', native:'አማርኛ',          english:'Amharic',    speakers:'32M',  exam:'CEFR',               accent:'#078930', light:'#E5F1E8', tier:'soon', region:'Africa' },
    { code:'ka', native:'ქართული',     english:'Georgian',   speakers:'3.7M', exam:'CEFR',              accent:'#FF0000', light:'#FFE5E5', tier:'soon', region:'Asia' },
    { code:'hy', native:'Հայերեն',      english:'Armenian',   speakers:'6.7M', exam:'CEFR',              accent:'#0033A0', light:'#E5EAF4', tier:'soon', region:'Asia' },
    { code:'az', native:'Azərbaycanca',english:'Azerbaijani',speakers:'23M',  exam:'CEFR',              accent:'#00B5E2', light:'#E0F4FB', tier:'soon', region:'Asia' },
    { code:'kk', native:'Қазақша',     english:'Kazakh',     speakers:'13M',  exam:'KAZTEST',           accent:'#00ABC9', light:'#E0F4F7', tier:'soon', region:'Asia' },
    { code:'uz', native:'Oʻzbek',      english:'Uzbek',      speakers:'34M',  exam:'CEFR',               accent:'#1EB53A', light:'#E5F4E7', tier:'soon', region:'Asia' },
    { code:'ky', native:'Кыргызча',    english:'Kyrgyz',     speakers:'5M',   exam:'CEFR',               accent:'#E8112D', light:'#FBE5E7', tier:'soon', region:'Asia' },
    { code:'tg', native:'Тоҷикӣ',      english:'Tajik',      speakers:'8M',   exam:'CEFR',            accent:'#CC0000', light:'#FBE5E5', tier:'soon', region:'Asia' },
    ...
    { code:'sa', native:'संस्कृतम्',         english:'Sanskrit',   speakers:'classical',exam:'CEFR',          accent:'#FF9933', light:'#FFEFD9', tier:'soon', region:'Classical' },
    { code:'qu', native:'Runa Simi',   english:'Quechua',    speakers:'8M',   exam:'CEFR',               accent:'#D90000', light:'#FBE5E5', tier:'soon', region:'Americas' },
    { code:'haw',native:'ʻŌlelo Hawaiʻi',english:'Hawaiian', speakers:'18K',  exam:'CEFR',                accent:'#CE1126', light:'#FBE5E8', tier:'soon', region:'Oceania' },
    ...
    { code:'jv', native:'Basa Jawa',   english:'Javanese',   speakers:'82M',  exam:'CEFR',               accent:'#A91827', light:'#FBE6E8', tier:'soon', region:'Asia' },
    { code:'su', native:'Basa Sunda',  english:'Sundanese',  speakers:'40M',  exam:'CEFR',               accent:'#FFB81C', light:'#FFF4D9', tier:'soon', region:'Asia' },
    { code:'lo', native:'ລາວ',          english:'Lao',        speakers:'30M',  exam:'CEFR',              accent:'#CE1126', light:'#FBE5E8', tier:'soon', region:'Asia' },
    { code:'ps', native:'پښتو',         english:'Pashto',     speakers:'45M',  exam:'CEFR',                accent:'#000000', light:'#F0F0F0', tier:'soon', region:'Asia' },
    { code:'so', native:'Soomaali',    english:'Somali',     speakers:'22M',  exam:'CEFR',               accent:'#418FDE', light:'#E5EFFB', tier:'soon', region:'Africa' },
    { code:'rw', native:'Ikinyarwanda',english:'Kinyarwanda',speakers:'12M',  exam:'CEFR',                accent:'#00A1DE', light:'#E0F4FB', tier:'soon', region:'Africa' },
  ];
