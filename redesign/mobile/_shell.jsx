...
function MobileFrame({ children, statusBarStyle='dark', dark=false }) {
  ...
  return (
    <div style={{ width:W, height:H, background:'#000', borderRadius:54, padding:8, boxShadow:'0 30px 80px rgba(0,0,0,.28), 0 0 0 1px rgba(0,0,0,.04)', flexShrink:0 }}>
      <div style={{ width:'100%', height:'100%', background: dark ? '#0E0D0B' : 'radial-gradient(520px 380px at 6% -10%, rgba(255,142,98,0.54), transparent 58%), radial-gradient(480px 380px at 104% -2%, rgba(132,142,255,0.46), transparent 56%), radial-gradient(480px 480px at 50% 120%, rgba(108,212,164,0.38), transparent 60%), linear-gradient(150deg,#F6F1EA,#EAE4DB)', borderRadius:46, overflow:'hidden', position:'relative', display:'flex', flexDirection:'column' }}>
