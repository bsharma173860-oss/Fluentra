  ...
  return (
    <>
      ...
      <MobileBody padding={[0,16,30]} tabBarPad={false}>
        ...
        <button onClick={function(){ window.__nav && window.__nav('activity_feed'); }} style={{ width:'100%', marginBottom:14, padding:'11px', borderRadius:11, border:`1px solid ${T.border}`, background:T.card, color:T.ink2, fontSize:13, fontWeight:700 }}>📣 Open the activity feed →</button>
        <div style={{ display:'flex', gap:0, background:T.bg2, borderRadius:11, padding:3, marginBottom:14, border:`1px solid ${T.border}` }}>
